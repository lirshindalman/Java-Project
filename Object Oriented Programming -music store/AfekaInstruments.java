...
public class AfekaInstruments extends Application  {
	...
	private static ArrayList<MusicalInstrument> allInstruments;
	...
	public void start(Stage arg0) throws Exception {
        ...
        AfekaInstumenrsPane afekaInstumenrsPane=new AfekaInstumenrsPane();
        afekaInstumenrsPane.show();
    ...
    public static File getInstrumentsFileFromUser(){
        ...
        do {
            ...
            if(!stopLoop) {
            	alert("File","Cant read from file, please try again").showAndWait();
            }
    ...
    public static Alert alert(String type,String textAlert) {
